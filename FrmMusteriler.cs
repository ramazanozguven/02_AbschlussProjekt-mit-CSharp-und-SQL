...
namespace Aycicegi_Pansiyon_ve_Dinlenme_Tesisleri
{
    public partial class FrmMusteriler : Form
    {
        ...
        private void verilergoster()
        {
            ...
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from MusteriEkle4", baglanti);
        ...
        {
            baglanti.Open();
            SqlCommand komut = new SqlCommand("delete from MusteriEkle4 where Musteriid=(" + id + ")", baglanti);
        ...
        private void BtnAra_Click(object sender, EventArgs e)
        {
            listView1.Items.Clear();
            baglanti.Open();
            SqlCommand komut = new SqlCommand("select * from MusteriEkle4 where Adi like '%" + textBox1.Text +"%' ", baglanti);
            SqlDataReader oku = komut.ExecuteReader();
